...
public class StoreController {
    ...
    @PostMapping("count")
    public ResponseEntity<List<StoreCount>> getStoreCount() {
        List<StoreCount> storeCounts = storeService.getStoreCount();
        if (storeCounts != null) return ResponseEntity.ok().body(storeCounts);
