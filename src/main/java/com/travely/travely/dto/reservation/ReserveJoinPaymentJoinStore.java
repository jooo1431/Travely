...
public class ReserveJoinPaymentJoinStore {
    ...
    public ReserveJoinPaymentJoinStore(long reserveIdx, long userIdx, long storeIdx, Timestamp startTime, Timestamp endTime, StateType stateType, long price, long deleted, String reserveCode, Timestamp depositTime, Timestamp takeTime, long payIdx, PayType payType, ProgressType progressType, long ownerIdx, String storeName, long regionIdx, String storeCall, String storeUrl, String address, String openTime, String closeTime, double latitude, double longitude, long limit) {
